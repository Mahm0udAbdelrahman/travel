...
return [
    ...
    | las reglas de tamaño. No dude en ajustar cada uno de estos mensajes aquí.
    |
    */
    ...
    | la convención "attribute.rule" para nombrar las líneas. Esto facilita la
    | especificación rápida de un mensaje personalizado específico para una regla dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se usan para intercambiar marcadores de posición
    | de atributos con algo más legible, como "Correo electrónico" en lugar de "email".
    |
    */
    ...
    'attributes' => [
        ...
        'time'                  => 'hora',
        'type'                  => 'tipo',
        'additional_service_id' => 'servicio adicional',
        'notes'                 => 'notas',
    ],
