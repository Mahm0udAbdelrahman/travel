...
return [
    ...
    | telles que les règles de taille. N'hésitez pas à modifier ces messages.
    |
    */
    ...
    'enum'                 => "La sélection du champ :attribute n’est pas valide.",
    'exists'               => "La sélection du champ :attribute n’est pas valide.",
    ...
    'in'                   => 'La sélection du champ :attribute n’est pas valide.',
    ...
    'not_in'               => 'La sélection du champ :attribute n’est pas valide.',
    ...
    | la spécification rapide d’un message personnalisé spécifique pour une règle donnée.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes sont utilisées pour échanger le placeholder de l’attribut
    ...
    */
    ...
    'attributes' => [
        ...
        'time'                  => 'heure',
        'type'                  => 'type',
        'additional_service_id' => 'service supplémentaire',
        'notes'                 => 'notes',
    ],
