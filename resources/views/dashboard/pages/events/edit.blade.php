        ...
        <div class="page-header">
            <div class="page-block">
                <div class="page-header-title">
                    <h5 class="mb-0">{{ __('Edit Event') }}</h5>
                </div>
                <ul class="breadcrumb">
                            ...
                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text"
                                               name="name[{{ $key }}]"
                                               value="{{ old("name.$key", data_get($event->name, $key)) }}"
                                               class="form-control">
                                        @error("name.$key")
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old("description.$key", data_get($event->description, $key)) }}"
                                               class="form-control">
                                ...
                                <select name="category_event_id" class="form-select">
                                    ...
                                    @foreach($category_events as $category)
                                        <option value="{{ $category->id }}"
                                            {{ old('category_event_id', $event->category_event_id) == $category->id ? 'selected' : '' }}>
                    ...
                    <div class="card shadow-sm border-0 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <select name="is_active" class="form-select">
                                <option value="1" {{ old('is_active', $event->is_active) == 1 ? 'selected' : '' }}>
                                    {{ __('Active') }}
                                </option>
                                <option value="0" {{ old('is_active', $event->is_active) == 0 ? 'selected' : '' }}>
                                    {{ __('UnActive') }}
                                </option>
                            </select>
