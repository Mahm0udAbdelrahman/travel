                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="description[ar]" id="description_ar"
                                            value="{{ old('description.ar') }}" class="form-control"
                                            placeholder="{{ __('Enter the city name') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="description[en]" id="description_en"
                                            value="{{ old('description.en') }}" class="form-control"
                                            placeholder="{{ __('Enter the city name') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="description[es]" id="description_es"
                                            value="{{ old('description.es') }}" class="form-control"
                                            placeholder="{{ __('Enter the city name') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="description[it]" id="description_it"
                                            value="{{ old('description.it') }}" class="form-control"
                                            placeholder="{{ __('Enter the city name') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="description[de]" value="{{ old('description.de') }}"
                                            class="form-control">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="description[ja]" value="{{ old('description.ja') }}"
                                            class="form-control">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="description[zh]" value="{{ old('description.zh') }}"
                                            class="form-control">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="description[ru]" value="{{ old('description.ru') }}"
                                            class="form-control">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="description[fr]" value="{{ old('description.fr') }}"
                                            class="form-control">
