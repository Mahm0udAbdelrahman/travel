...
@section('title', __('Edit Category Excursion'))
...
@section('content')
    <div class="pc-container">
        <div class="pc-content">
            ...
            <div class="page-header">
                <div class="page-block">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('Admin.category_excursions.index') }}">{{ __('Category Excursions') }}</a></li>
                        <li class="breadcrumb-item" aria-current="page">{{ __('Edit Category Excursion') }}</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row mb-5">
                <div class="col-12">
                    <form method="post" action="{{ route('Admin.category_excursions.update', $category_excursion->id) }}"
                        ...
                        <div class="card border-0">
                            <div class="card-header bg-primary text-white rounded-top">
                                <h5 class="mb-0">{{ __('Edit Category Excursion') }}</h5>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name[de]"
                                            value="{{ old('name.de', data_get($category_excursion->name, 'de')) }}" class="form-control">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Name Ja</label>
                                        <input type="text" name="name[ja]"
                                            value="{{ old('name.ja', data_get($category_excursion->name, 'ja')) }}" class="form-control">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Name Zh</label>
                                        <input type="text" name="name[zh]"
                                            value="{{ old('name.zh', data_get($category_excursion->name, 'zh')) }}" class="form-control">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Name Ru</label>
                                        <input type="text" name="name[ru]"
                                            value="{{ old('name.ru', data_get($category_excursion->name, 'ru')) }}" class="form-control">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Name Fr</label>
                                        <input type="text" name="name[fr]"
                                            value="{{ old('name.fr', data_get($category_excursion->name, 'fr')) }}" class="form-control">
                                    </div>
