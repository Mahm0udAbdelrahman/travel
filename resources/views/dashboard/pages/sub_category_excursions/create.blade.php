...
@section('title', __('Add Sub Category Excursion'))
...
@section('content')
    <div class="pc-container">
        <div class="pc-content">
            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="page-header-title">
                        <h5 class="mb-0 font-medium">{{ __('Add Sub Category Excursion') }}</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('Admin.home') }}">{{ __('Home') }}</a></li>
                        <li class="breadcrumb-item"><a
                                href="{{ route('Admin.sub_category_excursions.index') }}">{{ __('Sub Category Excursions') }}</a></li>
                        <li class="breadcrumb-item" aria-current="page">{{ __('Add Sub Category Excursion') }}</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row mb-5">
                <div class="col-12">
                    <form method="post" action="{{ route('Admin.sub_category_excursions.store') }}" enctype="multipart/form-data"
                        class="p-3 rounded shadow-lg bg-white">
                        @csrf
                        <div class="card border-0">
                            <div class="card-header bg-primary text-white rounded-top">
                                <h5 class="mb-0">{{ __('Add Sub Category Excursion') }}</h5>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
