...
@section('content')
            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="page-header-title">
                        <h5 class="mb-0 font-medium">{{ __('Add City') }}</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('Admin.home') }}">{{ __('Home') }}</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('Admin.cities.index') }}">{{ __('Cities') }}</a></li>
                        <li class="breadcrumb-item" aria-current="page">{{ __('Add City') }}</li>
                    </ul>
                </div>
            </div>
    ...
    <input type="text" name="name[de]" value="{{ old('name.de') }}" class="form-control">
    @error('name.de') <small class="text-danger">{{ $message }}</small> @enderror
</div>

<div class="col-md-6">
    <label class="form-label">Name Ja</label>
    <input type="text" name="name[ja]" value="{{ old('name.ja') }}" class="form-control">
    @error('name.ja') <small class="text-danger">{{ $message }}</small> @enderror
</div>

<div class="col-md-6">
    <label class="form-label">Name Zh</label>
    <input type="text" name="name[zh]" value="{{ old('name.zh') }}" class="form-control">
    @error('name.zh') <small class="text-danger">{{ $message }}</small> @enderror
</div>

<div class="col-md-6">
    <label class="form-label">Name Ru</label>
    <input type="text" name="name[ru]" value="{{ old('name.ru') }}" class="form-control">
    @error('name.ru') <small class="text-danger">{{ $message }}</small> @enderror
</div>

<div class="col-md-6">
    <label class="form-label">Name Fr</label>
    <input type="text" name="name[fr]" value="{{ old('name.fr') }}" class="form-control">
    @error('name.fr') <small class="text-danger">{{ $message }}</small> @enderror
</div>
