            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="page-header-title">
                        <h5 class="mb-0 font-medium">{{ __('Edit City') }}</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('Admin.home') }}">{{ __('Home') }}</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('Admin.cities.index') }}">{{ __('Cities') }}</a></li>
                        <li class="breadcrumb-item" aria-current="page">{{ __('Edit City') }}</li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name[ar]" id="name_ar"
                                            value="{{ old('name.ar', data_get($city->name, 'ar', '')) }}"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name[en]" id="name_en"
                                            value="{{ old('name.en', data_get($city->name, 'en', '')) }}"
                                            class="form-control" placeholder="{{ __('Enter the city name') }}">
                                        @error('name.en')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name[es]" id="name_es"
                                            value="{{ old('name.es', data_get($city->name, 'es', '')) }}"
                                            class="form-control" placeholder="{{ __('Enter the city name') }}">
                                        @error('name.es')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name[it]" id="name_it"
                                            value="{{ old('name.it', data_get($city->name, 'it', '')) }}"
                                            class="form-control" placeholder="{{ __('Enter the city name') }}">
                                        @error('name.it')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name[de]"
                                            value="{{ old('name.de', data_get($city->name, 'de')) }}" class="form-control">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Name Ja</label>
                                        <input type="text" name="name[ja]"
                                            value="{{ old('name.ja', data_get($city->name, 'ja')) }}" class="form-control">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Name Zh</label>
                                        <input type="text" name="name[zh]"
                                            value="{{ old('name.zh', data_get($city->name, 'zh')) }}" class="form-control">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Name Ru</label>
                                        <input type="text" name="name[ru]"
                                            value="{{ old('name.ru', data_get($city->name, 'ru')) }}" class="form-control">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Name Fr</label>
                                        <input type="text" name="name[fr]"
                                            value="{{ old('name.fr', data_get($city->name, 'fr')) }}" class="form-control">
                                    </div>
