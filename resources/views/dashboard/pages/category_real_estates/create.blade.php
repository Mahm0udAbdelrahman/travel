...
@section('content')
    <div class="pc-container">
        <div class="pc-content">
                ...
                <div class="page-block">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('Admin.category_real_estates.index') }}">{{ __('Category Real Estates') }}</a></li>
            ...
            <div class="row mb-5">
                <div class="col-12">
                    <form method="post" action="{{ route('Admin.category_real_estates.store') }}" enctype="multipart/form-data"
