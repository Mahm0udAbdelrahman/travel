...
@section('title', __('Add Category Real Estate'))
...
@section('content')
    <div class="pc-container">
        <div class="pc-content">
            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="page-header-title">
                        <h5 class="mb-0 font-medium">{{ __('Add Category Real Estates') }}</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('Admin.home') }}">{{ __('Home') }}</a></li>
                        <li class="breadcrumb-item"><a
                                href="{{ route('Admin.category_real_estates.index') }}">{{ __('Category Real Estates') }}</a>
                        </li>
                        <li class="breadcrumb-item" aria-current="page">{{ __('Add Category Real Estates') }}</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row mb-5">
                <div class="col-12">
                    <form method="post" action="{{ route('Admin.category_real_estates.store') }}"
                        enctype="multipart/form-data" class="p-3 rounded shadow-lg bg-white">
                        @csrf
                        <div class="card border-0">
                            <div class="card-header bg-primary text-white rounded-top">
                                <h5 class="mb-0">{{ __('Add Category Real Estates') }}</h5>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="name[ar]" id="name_ar" value="{{ old('name.ar') }}"
                                            class="form-control"
                                            placeholder="{{ __('Enter the category real estate name') }}">
                                        @error('name.ar')
