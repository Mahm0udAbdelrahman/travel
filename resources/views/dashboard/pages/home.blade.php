                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    <tbody>
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="{{ asset('dashboard/assets/images/user/avatar-1.jpg')}}" alt="activity-user" />
                        </td>
                        <td>
                      ...
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="{{ asset('dashboard/assets/images/user/avatar-2.jpg')}}" alt="activity-user" />
                        </td>
                        <td>
                      ...
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="{{ asset('dashboard/assets/images/user/avatar-3.jpg')}}" alt="activity-user" />
                        </td>
                        <td>
