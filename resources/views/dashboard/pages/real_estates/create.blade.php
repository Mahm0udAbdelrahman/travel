...
@section('title', __('Add Real Estate'))
        ...
        <div class="page-header">
            <div class="page-block">
                <div class="page-header-title">
                    <h5 class="mb-0">{{ __('Add Real Estate') }}</h5>
                </div>
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ __('Add Real Estate') }}</li>
                </ul>
            </div>
        </div>
                                ...
                                <select name="category_real_estate_id" class="form-select">
                                    ...
                                    @foreach($category_real_estates as $category)
                                        <option value="{{ $category->id }}"
                                            {{ old('category_real_estate_id') == $category->id ? 'selected' : '' }}>
