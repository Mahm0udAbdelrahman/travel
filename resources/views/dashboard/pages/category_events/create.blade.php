...
@section('title', __('Add Category Events'))
...
@section('content')
    <div class="pc-container">
        <div class="pc-content">
            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="page-header-title">
                        <h5 class="mb-0 font-medium">{{ __('Add Category Events') }}</h5>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('Admin.home') }}">{{ __('Home') }}</a></li>
                        <li class="breadcrumb-item"><a
                                href="{{ route('Admin.category_events.index') }}">{{ __('Category Events') }}</a></li>
                        <li class="breadcrumb-item" aria-current="page">{{ __('Add Category Events') }}</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row mb-5">
                <div class="col-12">
                    <form method="post" action="{{ route('Admin.category_events.store') }}" enctype="multipart/form-data"
