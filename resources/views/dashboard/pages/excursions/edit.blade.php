...
<div class="row g-2 mb-2 align-items-end time-block">
    ...
    <div class="col-md-6">
        ...
        <div class="d-flex gap-2">
            <input type="time" name="times[${timeIndex}][from_time]" class="form-control" value="${fromVal}" required>
            <input type="time" name="times[${timeIndex}][to_time]" class="form-control" value="${toVal}" required>
        </div>
    </div>
